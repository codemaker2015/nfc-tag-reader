package com.codemaker.nfcexplorer;
...
public class MainActivity extends Activity {
    ...
    private TextView currentTagView, currentTagInfo;
    ...
    public void onCreate(final Bundle savedState) {
        ...
        currentTagInfo = (TextView) findViewById(R.id.tag_info);
    ...
    public void onNewIntent(Intent intent) {
        ...
        if (rawMsgs != null) {
            ...
            try {
                ...
                tagInfo = tagData;
                currentTagInfo.setText(tagData);
                Linkify.addLinks(currentTagInfo, Linkify.WEB_URLS | Linkify.PHONE_NUMBERS);
        ...
        info.add("tag data: " + tagData);
        tagWrapper.techList.put("Information: " + tagData, info);

        for (String tech : tag.getTechList()) {
            tech = tech.replace("android.nfc.tech.", "");
            List<String> tagInfo = getTagInfo(tag, tech);
            tagWrapper.techList.put("Technology: " + tech, tagInfo);
        }
    ...
    String readRecord(byte[] payload) throws UnsupportedEncodingException {
        ...
        int languageCodeLength = payload[0] & 128;
            ...
            case "Ndef":
                ...
                try {
                    ...
                    for (final NdefRecord record : ndefMessage.getRecords()) {
                        final String id = record.getId().length == 0 ? "0" : Utils.bytesToHex(record.getId());
